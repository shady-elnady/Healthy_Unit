...
class ProfileInlineForm(StackedInline.form):
    def __init__(self, *args, **kwargs):
        super(ProfileInlineForm, self).__init__(*args, **kwargs)
    ...
    @cached_property
    def nested(self):
        modeladmin = ProfileAdmin(self._meta.model, self.modeladmin.admin_site)
...
class ProfileInline(StackedInline):
    ...
    readonly_fields = ("nick_name_inline",)
