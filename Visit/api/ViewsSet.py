...
from .Serializer import VisitSerializer, VisitVitalSignSerializer


class VisitVitalSignViewSet(ModelViewSet):
    queryset = VisitVitalSign.objects.all()
    ...
    ordering_fields = "id"
    filterset_fields = ["id"]
    search_fields = ["visit", "vital_sign"]
