...
# from ..utils.authentication import auth as firebase_admin_auth

# from ..utils.password_reset_link import (
#     generate_custom_password_link_from_firebase,
# )
...
#             )
#             decode_access_token = firebase_admin_auth.verify_id_token(
#                 user_firebase_access_token
#             )
